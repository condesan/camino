...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix">
  ...
  <div class="content">
    <?php #print $content; ?>
		...
		$datosper = _theme_cck_field('field_recursos_apellidos', 'recursos', $node);
		$datosper .=  _theme_cck_field('field_recursos_nombres', 'recursos', $node);
		$datosper .=  _theme_cck_field('field_recurso_anoedicion', 'recursos', $node);
		$datosper .=  _theme_cck_field('field_recursos_fuente', 'recursos', $node);
		$datosper .=  _theme_cck_field('field_recursos_editorial', 'recursos', $node);
		$datosper .= _theme_cck_field('field_descripcion', 'recursos', $node);

		$datosper .= _theme_cck_field('field_taxonomy_pais', 'recursos', $node);
